Function SSRLBL15_SAXS_Monitor_Dark(FileName)
         string FileName
    //
	//HOW TO USE//////////////////////////////////////////////////////////////////////////
    ...
    NewPath/O csvPath S_path
	 ...
	 //////////////////////////////////////////////////////////////////////////////////////
	 // BEGIN DARK MONITOR PROCEDURE //
	 //////////////////////////////////////////////////////////////////////////////////////
    string dark_TextFileName                 //place for the file name
    variable dark_NumOfSeparators2            //need a number
    dark_NumOfSeparators2 = ItemsInList(FileName, "_")
    dark_TextFileName = ReplaceString(".raw", FileName, "")       //remove the XX.tif part                  //remove "_"      //number of string parts separated by "_"

    string dark_EndStuff2=StringFromList(dark_NumOfSeparators2-1, dark_TextFileName, "_")
    variable dark_csvListNum=str2num(dark_EndStuff2)
    //print csvListNum
    
    //EndStuff2 = EndStuff2[1, strlen(EndStuff2) - 2]
    dark_TextFileName = ReplaceString(dark_EndStuff2, dark_TextFileName, "")
    dark_TextFileName = removeEnding(dark_TextFileName, "_")
    
    string dark_FrontStuff=StringFromList(0, dark_TextFileName, "_")
    //print "Front Stuff = "+ FrontStuff
    dark_TextFileName = ReplaceString(dark_FrontStuff+"_", dark_TextFileName, "")
    dark_TextFileName = "dark_"+dark_TextFileName
    
                                                           //this is the XX.tif part
	 dark_TextFileName = dark_TextFileName+".csv"                         //add .txt to the name
                                    //this should be the text file name now.
    print dark_TextFileName            //for testing purposes
    ...
    variable dark_i, dark_refNum
    string dark_aLine
        //Open the file as read only.
        //We need to eventually close it so it does not stay open!
    Open /P=csvPath /R /T=".csv" dark_refNum as dark_TextFileName
    ...
    //For(i=0;i<34;i+=1)                                    //35 lines of header info
      FreadLine dark_refNum, dark_aLine
      //print dark_aLine                                    //for testing
    //endfor
    //    
    //    
	//////////////////////////////////////////////////////////////////////////////////////
    ...
    //Do                                    //this loop could be done better
      ...
      FreadLine dark_refNum, dark_aLine         //read the line
      //print dark_aLine
                                //else back in the loop...
    close dark_refNum              //important, close the file.
	...
	dark_aLine=ReplaceString(" ", dark_aLine, "")			//add spaces between parameter name, =, and value
	dark_aLine=ReplaceString(",", dark_aLine, ";")				//remove commas
    //print aLine                                                     //for testing
        //
		//////////////////////////////////////////////////////////////////////////////////
		//now we need to find the right number and return it to Nika...
    variable dark_monitor
    variable dark_seconds
    variable dark_norm
    ...
    dark_monitor = str2num(StringFromList(3, dark_aline, ";"))                   //Seconds
    dark_seconds = str2num(StringFromList(2, dark_aline, ";"))
    dark_norm = dark_monitor/dark_seconds
	//print "Dark Monitor = " + num2str(dark_monitor)
	//print "Dark Time = " + num2str(dark_seconds)
	//print "Dark Normalized = " + num2str(dark_norm)
   ...
   string TextFileName                 //place for the file name
    ...
    sample_offset = dark_norm*sample_time
    mon_corr = result-sample_offset
    
	print "Monitor = " + num2str(result)
	print "Corrected Monitor = " + num2str(mon_corr)
    return mon_corr
end